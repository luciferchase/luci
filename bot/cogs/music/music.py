...
class Music(commands.Cog):
    ...
    async def connect_(self, ctx, *, channel: discord.VoiceChannel = None):
        ...
        channel: discord.VoiceChannel [Optional]
            The channel to connect to. If a channel is not specified, an attempt to join the voice channel \
            you are in
            will be made.
        This command also handles moving the bot to different channels.
        Note - The channel has to have 'music' in it's name. This is to avoid spamming music \
        in general voice chats.
        """
        if not channel:
            try:
